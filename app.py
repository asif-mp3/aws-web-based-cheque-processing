...
# Create a list of examples to be loaded
...
with demo:
    ...
    with gr.Tabs():
        with gr.TabItem("Cheque Parser"):
            ...
            - Additionally, the app compares if the extracted legal & courtesy amount are matching, which is an important check done during the approval process of cheques. \
            ...
            with gr.Row():
                gr.Examples(
                    example_list,
                    [input_image_parse],
                    [payee_name, amt_in_words, amt_in_figures, cheque_date],
